...
public class TracingPreparedStatement extends TracingStatement implements PreparedStatement {
    ...
    public TracingPreparedStatement(PreparedStatement preparedStatement, String query, ConnectionInfo connectionInfo) {
        super(preparedStatement, query, connectionInfo);
        this.preparedStatement = preparedStatement;
        this.query = query;
    }

    public ResultSet executeQuery() throws SQLException {
        buildSpan(query, "executeQuery", connectionInfo);
        try {
    ...
    public int executeUpdate() throws SQLException {
        buildSpan(query, "executeUpdate", connectionInfo);
        try {
    ...
    public boolean execute() throws SQLException {
        buildSpan(query, "execute", connectionInfo);
        try {
